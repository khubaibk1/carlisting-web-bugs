    ...
    return (
        <div className={`fixed inset-0 flex flex-col justify-start items-start md:items-center md:justify-center z-[99] ${isOpen ? 'visible opacity-100' : 'invisible opacity-0'}`}>
            ...
            <div className="bg-white px-5 md:px-6 py-6 shadow-md w-full h-screen md:h-auto md:w-[558px]">
                ...
                <h2 className="text-[20px] font-[600] md:font-[500] text-[#141415] md:text-center mb-4">Sign in</h2>
                <p className='text-[14px] font-[400] md:text-center'>Enter your email to sign into your account</p>
                ...
                <div className="flex justify-center flex-col items-center mt-10 md:mt-0 ">
                    ...
                    <button className="text-[12px] font-[400] md:font-[600] mt-3" >
                        ...
                        <a href="" className='text-[#09A122] hover:underline'> Forgot your password?</a>
                    </button>
                </div>
            </div>
