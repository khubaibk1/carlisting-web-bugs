    ...
    if (tab === 'used' && (subTab === 'clear' || subTab === 'all')) {
        return (
            <div ref={dropdownRef} className="relative">
                <div
                    className={` px-5 md:px-6 py-2 rounded-md flex items-center justify-between gap-[25px] h-[50px] cursor-pointer`}
                ...
                {isOpen && (
                    <div className="absolute mt-2 z-50 w-[320px] h-[300px] overflow-y-scroll bg-white shadow-lg rounded-md">
                        {options.map((option) => (
                            <div
                                key={option}
